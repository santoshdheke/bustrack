    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route(config('bus.url_prefix').'.bus.update',$bus->id) }}" class="jqueryValidation form-horizontal form-label-left"
                          novalidate method="post">
                        @csrf @method('put')

                        @include(('bustracking::bus.common.form'))
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <a href="{{ route(config('bus.url_prefix').'.bus.create') }}" id="reset" class="btn btn-default">Add</a>
                            </div>
                        </div>
                    </form>
                </div>
